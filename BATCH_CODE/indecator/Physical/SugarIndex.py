...
class SUGARDailyBatchOut:
    ...
    # -------------------------------------------------
    def read_SUGAR_page(self, page=1):
        try:
            url = (
                "https://finance.naver.com/marketindex/worldDailyQuote.naver"
                f"?marketindexCd=CMDT_SB&fdtc=2&page={page}"
            )
            ...
            for row in rows:
                ...
                data.append(["SUGAR", date, change_amount, round(rate, 4), close])
            ...
            print("[ERROR] SUGAR page error:", e)
            return pd.DataFrame()
    ...
    def execute(self):
        ...
        print("[INFO] SUGAR Batch-Out 완료")


if __name__ == "__main__":
    SUGARDailyBatchOut().execute()
