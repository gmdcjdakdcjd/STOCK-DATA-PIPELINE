...
class DualMomentumBatchUS6M:

    strategy_name = "DUAL_MOMENTUM_6M_US"

    def __init__(self):
        # MariaDB 기반 MarketDB
        self.mk = MarketDB()

        self.MIN_ABS_RETURN = 15.0   # 절대모멘텀 (%)
    ...
    def run(self, start_date, end_date):
        ...
        print(f"\n[DUAL MOMENTUM 6M US] ({start_date} ~ {end_date})\n")
