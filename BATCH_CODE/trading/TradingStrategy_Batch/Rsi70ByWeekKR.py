...
strategy_name = "RSI_70_OVERHEATED_WEEKLY_KR"
...
for code, group in df_all.groupby("code"):
    ...
    # 조건 필터링: 주봉 RSI 70 이상, 종가 10,000원 이상, 주간 거래량이 유효한 경우
    if (
        last["rsi"] >= 70 and
...
# =======================================================
if rsi_candidates:
    df_rsi = pd.DataFrame(rsi_candidates).sort_values(by="special_value", ascending=False)

    print(f"\n[{strategy_name}] RSI 70 이상 & 종가 10,000 이상 주봉 종목\n")
