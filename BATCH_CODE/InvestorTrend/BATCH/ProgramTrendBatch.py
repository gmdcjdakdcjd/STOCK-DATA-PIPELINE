...
class ProgramTrendDayBatch:
    ...
    # 네이버 프로그램 매매 (일자별) 수집
    # ------------------------------------------------------------
    def read_program_trend_day(self, pages_to_fetch):

        all_data = []

        base_url = "https://finance.naver.com/sise/programDealTrendDay.naver"
    ...
    def execute(self):
        ...
        df = self.read_program_trend_day(pages_to_fetch)
